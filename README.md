...
## 💡 解決的痛點 (Problem Solved)
在日常辦公中，常遇到需要將數十甚至數百份 Word 檔案中的特定詞彙（如公司名稱變更、合約條款更新）進行統一替換。手動逐一開啟並修改不僅耗時且容易出錯。此工具透過 C# 結合 Microsoft Office Interop，實現一鍵自動化批次替換，大幅提升工作效率並確保修改的一致性。
